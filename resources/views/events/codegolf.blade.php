...
<section id="about" class="electrolution" style="padding-top: 90px; color: black">
	<div class="container">
		...
		<div class="row">
			...
			<ul>
				<li>Scoring will be binary. There will not be any partial points for passing just a subset of the test cases.</li>
				<li>Each challenge has a predetermined maximum score where a higher score has a better rank.</li>
